    ...
    return `
        <div class="game-card" style="padding:16px;">
            <div style="text-align:center;margin-bottom:14px;">
                <div class="ex-tag">🔤 FASE 1 · SOPA DE LETRAS</div>
...
function renderDragDrop() {
    ...
    const words = [
        { text: verbData.verb, category: 'verb', label: 'Base Form' },
        { text: verbData.past, category: 'past', label: 'Past Simple' },
        { text: verbData.participle, category: 'participle', label: 'Past Participle' }
    ];
    ...
    const wordsHtml = shuffled.map(w => `
        <div 
            class="dd-word"
            draggable="true"
            data-word="${w.text}"
        ...
        <div class="screen active" id="scr-verbgame">
            ...
            <style>
                ...
                .dd-chip {
                    ...
                    font-weight:700;
                    font-size:15px;
                    animation:ddPop .25s ease;
                    box-shadow:0 10px 18px rgba(139,124,248,0.25);
                }
            ...
            <div class="game-body sb">
                ...
                <div class="dd-top-card">
                    ...
                    <div style="display:flex;flex-direction:column;gap:14px;">
                        ...
                        <div class="dd-zone dd-category" data-category="verb">
                            <div class="dd-title">
                                BASE FORM
                            </div>
                        ...
                        <div class="dd-zone dd-category" data-category="past">
                            <div class="dd-title">
                                PAST SIMPLE
                            </div>
                        ...
                        <div class="dd-zone dd-category" data-category="participle">
                            <div class="dd-title">
                                PAST PARTICIPLE
                            </div>
...
function initDragDropEvents() {
    ...
    const words = document.querySelectorAll('.dd-word');
...
function checkDragDropComplete() {
    ...
    if (allMatched && Object.keys(verbGameState.dragDropMatches).length === 3) {
        ...
        if (continueBtn) continueBtn.disabled = !allMatched;
    }
}
    ...
    document.getElementById('app').innerHTML = `
        <div class="screen active" id="scr-verbgame">
            <div class="hdr"><button class="back" onclick="renderMap()">←</button>
                <span style="font-size:12px;">🎮 Verb Quest · Fase 3/6 (${progress})</span>
                <button class="ico-btn" onclick="openOptions()">⚙️</button></div>
            <div class="game-body sb">
                <div class="game-card" style="padding:20px;">
                    <div style="text-align:center;margin-bottom:20px;">
                        <div class="ex-tag">✍️ FASE 3 · ESCRIBE LA FORMA CORRECTA</div>
...
// ════════════════════════════════════════════
// FASE 5: ORDENAR ORACIÓN (3 ejercicios)
// ════════════════════════════════════════════
...
function renderSentenceExercise() {
    ...
    document.getElementById('app').innerHTML = `
        <div class="screen active" id="scr-verbgame">
            <div class="hdr"><button class="back" onclick="renderMap()">←</button>
                <span style="font-size:12px;">🎮 Verb Quest · Fase 5/6 (${progress})</span>
                <button class="ico-btn" onclick="openOptions()">⚙️</button></div>
            <div class="game-body sb">
                <div class="game-card" style="padding:16px;">
...
function renderComplete() {
    verbGameState.completedExercises[5] = true;
    document.getElementById('app').innerHTML = `
        <div class="screen active" id="scr-verbgame">
            <div class="hdr"><button class="back" onclick="renderMap()">←</button>
            ...
            <div class="cmp-body sb">
                ...
                <div class="sgrid au">
                    ...
                    <div class="sc"><span class="sv">🌎</span><span class="sl">Traducción</span></div>
...
function startVerbGame(verbData, nodeIdx) {
    verbGameState = {
        ...
        completedExercises: [false, false, false, false, false, false],
        wordSearchFound: [],
        dragDropMatches: {},
        writtenAnswers: [],
